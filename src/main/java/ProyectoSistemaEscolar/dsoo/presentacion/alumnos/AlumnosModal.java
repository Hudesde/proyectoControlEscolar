...
public class AlumnosModal extends javax.swing.JFrame {

    Alumnos papa;
    int op;
    int idAlumno;
    public void opcion(int opcion,Alumnos p){
        op=opcion;
        papa = p;
        //System.out.println(p);
        if(op==1){
            tituloTxt.setText("Agregar Alumno");
            jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/crearAlumno.png")));
        }
        if(op==2){
            tituloTxt.setText("Editar Alumno");
            jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/actualizar1.png")));
        }
    }
    
    public void asignar(Alumno dato){
        idAlumno = dato.getId_alumno();
        ...
        matriculaTxt.setText(dato.getMatricula());
        contraTxt.setText(dato.getPassword());
    }
    ...
    private void initComponents() {
        ...
        contraTxt.setForeground(new java.awt.Color(45, 149, 150));
    ...
    private void enviarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarBtnActionPerformed
        if (!nombreTxt.getText().equals("") && !apellidoPaternoTxt.getText().equals("") && !apellidoMaternoTxt.getText().equals("") && !matriculaTxt.getText().equals("") && !correoTxt.getText().equals("") && !contraTxt.getText().equals("")) {
            AlumnoDaoImpl alumnoService = new AlumnoDaoImpl();
            Alumno alumno = new Alumno();
        
            if(op==1){
                alumno.setNombre(nombreTxt.getText());
                alumno.setApellido_paterno(apellidoPaternoTxt.getText());
                alumno.setApellido_materno(apellidoMaternoTxt.getText());
                alumno.setMatricula(matriculaTxt.getText());
                alumno.setCorreo(correoTxt.getText());
                alumno.setPassword(contraTxt.getText());
                if(alumnoService.registrarAlumno(alumno) != -1){
            ...
            if(op==2){
                ...
                alumno.setCorreo(correoTxt.getText());
                alumno.setPassword(contraTxt.getText());
                if(alumnoService.actualizarAlumno(alumno)){
                    JOptionPane.showMessageDialog(rootPane,"Usuario editado");
                    this.dispose();
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlumnosModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AlumnosModal().setVisible(true);
        });
    }
